...
public class DriveTrain {
  ...
  public WPI_TalonSRX m_leftFtrMotor = new WPI_TalonSRX(Constants.leftFrontMotor); // ID 15
  public WPI_TalonSRX m_leftRrMotor = new WPI_TalonSRX(Constants.leftRearMotor); // ID 14
  public WPI_TalonSRX m_rightFrtMotor = new WPI_TalonSRX(Constants.rightFrontMotor); // ID 0
  public WPI_TalonSRX m_rightRrMotor = new WPI_TalonSRX(Constants.rightRearMotor); // ID 1
  public XboxController m_driverController1 = new XboxController(Constants.driverControllerID); // ID 0
  ...
  // Motor speed variable (Moved to Constants.java)
  ...
  public void driveTank() {
      ...
      m_robotDrive.tankDrive(Math.pow(m_driverController1.getY(Hand.kLeft), 3) * Constants.driveTrainMotorSpeed, 
                             Math.pow(m_driverController1.getY(Hand.kRight), 3) * Constants.driveTrainMotorSpeed,
