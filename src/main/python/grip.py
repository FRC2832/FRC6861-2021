...
class PowerCellPipeline:
    ...
    def __init__(self):
        ...
        self.__hsl_threshold_saturation = [171.5296406942243, 255.0]
        self.__hsl_threshold_luminance = [79.69937609234644, 246.29692832764508]

        self.hsl_threshold_output = None

        self.__blur_input = self.hsl_threshold_output
        self.__blur_type = BlurType.Median_Filter
        self.__blur_radius = 5.575386707462178
